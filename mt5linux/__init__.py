...
## See also
    ...
    `CopyRates`, `copy_rates_from_pos`, `copy_rates_range`, `copy_ticks_from`, `copy_ticks_range`
        ...
        '''
        code=f'mt5.copy_rates_from("{symbol}", {timeframe}, {repr(date_from)}, {count})'
...
## See also
    ...
    `CopyRates`, `copy_rates_from`, `copy_rates_range`, `copy_ticks_from`, `copy_ticks_range`
        ...
        '''
        code=f'mt5.copy_rates_range("{symbol}", {timeframe}, {repr(date_from)}, {repr(date_to)})'
        return rpyc.utils.classic.obtain(self.__conn.eval(code))
...
## See also
    ...
    `CopyRates`, `copy_rates_from_pos`, `copy_rates_range`, `copy_ticks_from`, `copy_ticks_range`
        ...
        '''
        code=f'mt5.copy_ticks_from("{symbol}", {repr(date_from)}, {count}, {flags})'
        return rpyc.utils.classic.obtain(self.__conn.eval(code))
...
## See also
    ...
    `CopyRates`, `copy_rates_from_pos`, `copy_rates_range`, `copy_ticks_from`, `copy_ticks_range`
        '''
        code=f'mt5.copy_ticks_range("{symbol}", {repr(date_from)}, {repr(date_to)}, {flags})'
        return rpyc.utils.classic.obtain(self.__conn.eval(code))
...
2  548663803 2020-03-18 20:40:04     0      0   548663803       3    0.01     1.08640  1.06351  1.8001        1.10099 -0.08   14.59  EURUSD        
